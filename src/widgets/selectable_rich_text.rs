...
use iced::{
    self, Background, Border, Color, Element, Event, Length, Pixels, Point, Rectangle, Shadow,
...
impl<Message, Link, Theme, Renderer> Default for Rich<'_, Message, Link, Theme, Renderer>
where
    Link: self::Link + 'static,
    Theme: Catalog,
    Renderer: text::Renderer,
